...
macro_rules! clean_underline {
    () => {
        "\x1b[24m"
    };
}

macro_rules! last_start {
    () => {
        "\x1b[1A\x1b[G"
    };
} // back to last line's beginning

macro_rules! hyper_start {
    () => {
        "\x1B]8;;"
    };
}
macro_rules! hyper_text {
    () => {
        "\x07"
    };
}
macro_rules! hyper_end {
    () => {
        "\x1B]8;;\x07"
    };
}

macro_rules! italic_start {
    () => {
        "\x1B[3m"
    };
}
macro_rules! italic_end {
    () => {
        "\x1B[23m"
    };
}
...
macro_rules! reset_fg {
    () => {
        "\x1B[39m"
    };
}
macro_rules! reset_bg {
    () => {
        "\x1B[49m"
    };
}
